...
### Fixed
- Reset Tesla session state and retry once after HTTP 403 responses so the integration can recover from bot protection without manual intervention.

## [1.2.13] - 2026-04-18

### Fixed
- Moved Tesla SSL context creation off the event loop during session initialization to avoid blocking async work.

## [1.2.12] - 2026-04-18

### Added
- Automated GitHub release creation from the matching `CHANGELOG.md` section for each version bump.

## [1.2.11] - 2026-04-18

### Added
- Added support for German, French, Spanish, Italian, and Dutch translations in the config flow and entity labels.
